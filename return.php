      ...
      <div class="container">
        ...
        <div class="gallery-grids-top">
          <div class="gallery-grids gallery-grids-middle">
            <form class="" action="runner_request.php" method="post">

              <div class="form-group">
                <label for="">Select Pick Up Location:</label>
                <select required class="form-control" name="pickUpLoc">
                  <option value="">Please select...</option>
                  <option value="busStopA">Bus Stop Kg. A</option>
                  <option value="busStopB">Bus Stop Kg. B</option>
                  <option value="busStopC">Bus Stop Kg. C</option>
                  <option value="busStopD">Bus Stop Kg. D</option>
                  <option value="busStopE">Bus Stop Kg. E</option>
                </select>
                ...
                <select required class="form-control" name="time">
                  <option value="">Please select...</option>
                  <option value="0800">8:00 A.M.</option>
                  <option value="0900">9:00 A.M.</option>
            ...
            <div class="gallery-grids">
                <div class="form-group">
                  <button id="" class="btn btn-primary btn-lg" type="submit" name="requestBtn">Request Runner</button>
                </div>
              <div class="clearfix"> </div>
            </div>
